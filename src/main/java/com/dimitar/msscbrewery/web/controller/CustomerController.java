...
public class CustomerController {
    ...
    @PostMapping()
    public ResponseEntity<?> handlePost(final @RequestBody CustomerDto customerDto) {
    ...
    public ResponseEntity<?> handlePut(@PathVariable("customerId") UUID customerId, final @RequestBody CustomerDto customerDto){
